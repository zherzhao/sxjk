...
type F struct {
	...
	F编号 string `json:"编号" eorm:"编号"`
	F名称 string `json:"名称" eorm:"名称"`
	F类型 string `json:"类型" eorm:"类型"`
	//F路线名称      string `json:"路线名称" eorm:"路线名称"`
	F中心桩号 string `json:"中心桩号" eorm:"中心桩号"`
	F经度   string `json:"经度" eorm:"经度"`
	F纬度   string `json:"纬度" eorm:"纬度"`
...
type SM struct {
	...
	M所在行政区划代码 string `json:"所在行政区划代码" eorm:"所在行政区划代码"`
	M所在地级市    string `json:"所在地级市" eorm:"所在地级市"`
	M门架类型     string `json:"门架类型" eorm:"门架类型"`
	M门架种类     string `json:"门架种类" eorm:"门架种类"`
	M门架标志     string `json:"门架标志" eorm:"门架标志"`
	M省界入出口标识  string `json:"省界入出口标识" eorm:"省界入出口标识"`
...
type SZ struct {
	...
	S具体所在位置    string `json:"具体所在位置" eorm:"具体所在位置"`
	S收费路段编号    string `json:"收费路段编号" eorm:"收费路段编号"`
	S收费路段名称    string `json:"收费路段名称" eorm:"收费路段名称"`
	S收费站HEX字符串 string `json:"收费站HEX字符串" eorm:"收费站HEX字符串"`
	...
	S总车道数   string `json:"总车道数" eorm:"总车道数"`
	SETC车道数 string `json:"ETC车道数" eorm:"ETC车道数"`
	SMTC车道数 string `json:"MTC车道数" eorm:"MTC车道数"`
	S混合车道数  string `json:"混合车道数" eorm:"混合车道数"`
	S开通时间   string `json:"开通时间" eorm:"开通时间"`
	S收费站状态  string `json:"收费站状态" eorm:"收费站状态"`
	S经度     string `json:"经度" eorm:"经度"`
	S纬度     string `json:"纬度" eorm:"纬度"`
	S类型     string `json:"类型" eorm:"类型"`
	S实体类型   string `json:"实体类型" eorm:"实体类型"`
}
