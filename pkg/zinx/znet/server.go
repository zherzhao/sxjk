...
func (s *Server) Start() {
	log.Println("[Zinx] Conf:", global.ZinxSetting)
	...
	go func() {
		...
		for {
			...
			fmt.Println(global.ZinxSetting.MaxConn, s.ConnManager.Len())
			if s.ConnManager.Len() > global.ZinxSetting.MaxConn {
...
func NewServer(name string) ziface.IServer {
	s := &Server{
		Name:        global.ZinxSetting.Name,
		IPVersion:   "tcp4",
		IP:          global.ZinxSetting.Host,
		Port:        global.ZinxSetting.Port,
